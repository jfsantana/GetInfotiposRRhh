...
//		}
	  ...
	  if ($this->io_method() == 'socket') {
		...
		socket_set_timeout( $this->fp, $response_timeout);
          socket_set_timeout( $this->fp,3000);
...
class nusoap_client extends nusoap_base  {
	...
	var $username = 'PIUSERWS01';				// Username for HTTP authentication
	var $password = 'Pequiven21*';				// Password for HTTP authentication
	var $authtype = '';				// Type of HTTP authentication
	var $certRequest = array();		// Certificate for HTTP SSL authentication
    ...
    var $proxyhost = '';
    var $proxyport = '';
	var $proxyusername = 'PIUSERWS01';
	var $proxypassword = 'Pequiven21*';
