...
function generateTableRow6() {  /* Genera   la nueva FILA*/
	...
	emptyColumn2.innerHTML = '<div class="row recomendacionesOld" id="recomendacionesOld" name="recomendacionesOld" style="background: #fff; border:1px solid rgba(0, 0, 0, 0.125)" > <div class="col-xs-12 col-sm-12 col-md-1 col-lg-1" ><a class="cut6" id="cut6" name="cut6" style="position: relative;text-decoration:none;font-size: 150%;font-weight: bold; background:#ac5514; color: white;left: -1.5em;">-</a><span style="font-size: 130%; " ></span></div><div class="col-xs-12 col-sm-12 col-md-3 col-lg-5" ><input type="text" id="incidencia_recomendacionOld" name="incidencia_recomendacionOld[]"></div><div class="col-xs-12 col-sm-12 col-md-2 col-lg-2" ><input type="date" id="incidencia_inicioOld" name="incidencia_inicioOld[]"  ></div><div class="col-xs-12 col-sm-12 col-md-2 col-lg-2" ><input type="date" id="incidencia_planificacionOld" name="incidencia_planificacionOld[]" > </div><div class="col-xs-12 col-sm-12 col-md-2 col-lg-2" ><input type="text" id="incidencia_cierreOld" name="incidencia_cierreOld[]" ></div>';	
	updateInvoice();
	return emptyColumn2;
}
...
function onContentLoad() {
	...
	function onClick(e) {
		...
		//  ELIMINAR HALLAZGO NUEVO EN INCIDENCIA DIAGNOSTICO

		if (e.target.className == 'cut3') {
		...
		if (e.target.matchesSelector('.add3')) {
			document.querySelector('table.inventory tbody').appendChild(generateTableRow3());
			document.querySelector("input.indice_recomendacion").value= 1;
		...
		if (e.target.matchesSelector('.add4')) {

			var td = e.target.parentNode; 
			var tr = td.parentNode;
			var tr2 = tr.parentNode;
			tr2.querySelector('div.fila_recomendaciones').appendChild(generateTableRow4());

			updateInvoice();
		}	
/***********************************************************************************++****/

		// ELIMINAR RECOMENDACIONES NUEVAS EN HALLAZGOS OLD (ANTERIORES) DIAGNOSTIC
		...
		if (e.target.matchesSelector('.add6')) {

			var td = e.target.parentNode; 
			var tr = td.parentNode;
			var tr2 = tr.parentNode;
			tr2.querySelector('div.fila_recomendacionesOld').appendChild(generateTableRow6());
